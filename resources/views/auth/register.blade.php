    ...
    <div class="row justify-content-center">
        <div class="col-md-8 border-info">
            <div class="card border-info">
                <div class="card-header border-info text-info font-weight-bold">{{ __('Enregistrement') }}</div>
                ...
                <div class="card-body border-info">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Votre pseudo') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right">{{ __('Confirmation de votre mot de passe') }}</label>
